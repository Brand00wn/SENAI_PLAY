...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06/11/2025 às 01:18
...
INSERT INTO `alunos` (`id_aluno`, `nome`, `email`, `data_nascimento`) VALUES
(1, 'MIGUEL', 'MIGUEL@EMAIL.COM', '2007-11-04');
...
INSERT INTO `disciplina` (`id_disciplina`, `id_professor`, `nome`, `carga_horaria`) VALUES
(1, 1, 'MATEMATICA', 400);
...
INSERT INTO `matriculas` (`id_matricula`, `id_aluno`, `id_turma`, `data_matricula`) VALUES
(1, 1, 1, '2025-11-05');
...
INSERT INTO `professor` (`id_professor`, `nome`, `email`, `telefone`) VALUES
(1, 'MARCOS', 'MARCOS@EMAIL.COM', '2499999999');
...
INSERT INTO `turmas` (`id_turma`, `nome`, `ano`, `turno`) VALUES
(1, 'TURMA 1', '2025', 'MATUTINO');
...
--
-- Despejando dados para a tabela `turmas_disciplina`
--

INSERT INTO `turmas_disciplina` (`id_turma_disc`, `id_turma`, `id_disciplina`) VALUES
(1, 1, 1);
...
--
ALTER TABLE `alunos`
  MODIFY `id_aluno` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `disciplina`
--
ALTER TABLE `disciplina`
  MODIFY `id_disciplina` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `professor`
  MODIFY `id_professor` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `turmas`
--
ALTER TABLE `turmas`
  MODIFY `id_turma` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `turmas_disciplina`
--
ALTER TABLE `turmas_disciplina`
  MODIFY `id_turma_disc` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
